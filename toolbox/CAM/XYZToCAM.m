function CAMStats = XYZToCAM(XYZ_target,XYZ_white,LA,options)
...
XYZ_white = XYZ_white./XYZ_white(2);
...
% If calculating CAM16, the D value clipped on to the range 0-1.
if strcmp(options.whichCAM,'CAM16')
    D = max(0,min(1,D));
end
...
%
% Calculate the R'G'B' here. Set M_HPE matrix differently over differrent
% models.
switch options.whichCAM
    case 'CIECAM02'
...
CAMStats.describe.h = 'Hue angle (360)';
CAMStats.describe.H = 'Hue quadrature (400)';
CAMStats.describe.A = 'Brightness';
CAMStats.describe.J = 'Lightness';
CAMStats.describe.Q = 'Brightness';
CAMStats.describe.C = 'Chroma';
CAMStats.describe.M = 'Colorfulness';
CAMStats.describe.s = 'Saturation';
